...
import tollparking.PayMethod;

/**
 * Class for park definition. Every park has a name, a code, a set of @Slots
 * and a own pay method
 * @author davide
 *
 */
public class Parking implements Serializable {
  ...
  private static final long serialVersionUID = 1L;
	...
	public String toString() {
		return "Parking [slots=" + slots + ", name=" + name + ", code=" + code + ", payMethod=" + payMethod + "]";
	} 
